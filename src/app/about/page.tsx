...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen relative">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-[#C40001]/10 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-[#C40001]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#DAA521] font-medium mb-4">
                    {member.role}
                  </p>
                  <p className="text-gray-600">
                    {member.bio}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute left-0 md:left-1/2 ml-4 md:ml-0 transform md:-translate-x-1/2 h-full w-0.5 bg-[#C40001]"></div>
              ...
              <div className="space-y-12">
                {milestones.map((milestone, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="absolute left-0 md:left-1/2 ml-4 md:ml-0 transform md:-translate-x-1/2 w-8 h-8 bg-white rounded-full border-4 border-[#C40001] z-10"></div>
                    ...
                    <div className={`pl-12 md:pl-0 md:w-1/2 ${
                      ...
                      <span className={`inline-block px-4 py-1 text-white font-bold rounded-full mb-2 ${
                        index % 2 === 0 ? 'bg-[#C40001]' : 'bg-[#DAA625]'
                      }`}>
                        {milestone.year}
                      </span>
      ...
      <section className="py-16 bg-gray-50/80 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto bg-[#C40001] rounded-xl p-8 md:p-12 shadow-xl text-center">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
                <button className="bg-white text-[#C40001] hover:bg-gray-100 font-bold py-3 px-6 rounded-full">
                Hubungi Kami
              </button>
