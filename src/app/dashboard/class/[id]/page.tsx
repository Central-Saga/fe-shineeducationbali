    ...
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">{classDetail.title}</h1>
            <p className="text-gray-500">{classDetail.subject}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-2">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{classDetail.time}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="h-5 w-5 text-[#DAA625]" />
                <div>
                  <p className="text-sm text-gray-500">Lokasi</p>
                  <p className="font-medium">{classDetail.room}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{classDetail.teacher}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{classDetail.enrollment}/{classDetail.capacity} siswa</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {classDetail.groupLink ? (
                    <a href={classDetail.groupLink} target="_blank" rel="noopener noreferrer" className="text-[#C40503] hover:underline">
                      Link Grup Kelas
                    </a>
                  ) : (
                    <p className="text-gray-500 italic">Tidak ada</p>
                  )}
                </div>
              </div>
            </div>
            ...
            {classDetail.syllabus && classDetail.syllabus.length > 0 && (
              <div className="mt-6">
                <h3 className="text-lg font-semibold mb-3 text-[#C40503]">Silabus</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    {classDetail.syllabus.map((item, index) => (
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-medium">{classDetail.enrollment}/{classDetail.capacity}</span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-2">
                  <div
                    className="h-2 rounded-full bg-[#C40503]"
                    style={{ width: `${(classDetail.enrollment / classDetail.capacity) * 100}%` }}
                  ></div>
                </div>
                <p className="text-xs text-gray-500 mt-1 text-right">
                  {Math.round((classDetail.enrollment / classDetail.capacity) * 100)}% Terisi
                </p>
              </div>
