...
import { SubmitAssignmentCard } from "@/components/ui-student/classes/assignment";
...
export default function SubmitAssignmentPage() {
  ...
  return <SubmitAssignmentCard assignment={assignment} classId={classId} type={type || "kuis"} />;
}
