    ...
    submenu: [
      {
        ...
        description: "Lihat dan kelola semua kelas",
      },
      {
        name: "Jadwal Kelas",
        href: "/dashboard/classes/schedule",
        description: "Atur jadwal kelas dan guru",
      },
      {
        name: "Penempatan Siswa",
        href: "/dashboard/classes/assignments",
        description: "Atur penempatan siswa ke kelas",
      },
    ],
  },
  {
