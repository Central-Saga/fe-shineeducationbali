  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const certificateData = {
        studentId,
        studentName,
        courseId: "default-course", // TODO: Get from form or props
        courseName: values["metadata.courseName"] || "Default Course",
        issueDate: new Date().toISOString(),
        certificateNumber: `CERT-${Date.now()}`, // TODO: Generate proper number
        status: "draft" as "draft" | "issued" | "pending",
        grade: values["metadata.grade"] || "A",
        teacherName: values["signedBy.name"] || "Default Teacher",
        validUntil: values.validUntil,
        type: values.type,
        signedBy: values["signedBy.name"] || "Default Signer",
        previewUrl: "",
