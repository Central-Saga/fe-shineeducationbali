  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const certificateData = {
        studentId,
        studentName: studentName, // Add student name from props
        courseId: "default-course-id", // TODO: Implement course selection
        courseName: values["metadata.courseName"] || "Default Course",
        grade: values["metadata.grade"] || "A",
        teacherName: "Default Teacher", // TODO: Implement teacher selection
        certificateNumber: `CERT-${Date.now()}`, // Generate certificate number
        status: "draft" as "draft" | "issued" | "pending", // Set initial status as draft
        type: values.type,
        signedBy: values["signedBy.name"], // Convert to string as expected by interface
